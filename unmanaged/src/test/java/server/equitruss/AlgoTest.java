...
public class AlgoTest {
    ...
    public static final String MODEL_STATEMENT =
            new StringBuilder() // 词的索引:词:词频
                    .append("CREATE (p1:Author {authorId: '1', words: '1:DB:2@2:CV:1', attribute:'1,2,3'})")
                    .append("CREATE (p2:Author {authorId: '2', words: '4:MD:7@2:CV:1', attribute:'1,2,3'})")
                    .append("CREATE (p3:Author {authorId: '3', words: '5:AI:1@2:CV:1@4:DM:4', attribute:'1,2,3'})")
                    .append("CREATE (p4:Author {authorId: '4', words: '2:CV:1@3:ML:2@4:DM:1', attribute:'1,2,3'})")
                    .append("CREATE (p5:Author {authorId: '5', words: '2:CV:1@1:DB:2@4:DM:1', attribute:'1,2,3'})")
                    .append("CREATE (p6:Author {authorId: '6', words: '2:CV:1@4:DM:1', attribute:'1,2,3'})")
                    .append("CREATE (p7:Author {authorId: '7', words: '2:CV:8@4:DM:6', attribute:'1,2,3'})")
                    .append("CREATE (p8:Author {authorId: '8', words: '2:CV:1@4:DM:1@3:ML:4', attribute:'1,2,3'})")
                    .append("CREATE (p9:Author {authorId: '9', words: '2:CV:5@4:DM:2', attribute:'1,2,3'})")
                    .append("CREATE (p10:Author {authorId: '10', words: '2:CV:3@4:DM:6', attribute:'1,2,3'})")
                    .append("CREATE (p11:Author {authorId: '11', words: '2:CV:1@4:DM:1@5:AI:1', attribute:'1,2,3'})")
                    .append("CREATE (p12:Author {authorId: '12', words: '2:CV:1@4:DM:1', attribute:'1,2,3'})")
